...
@section('title', 'Forgot Password - Email Verification - MomasPay')
@section('body_class', '')
  ...
  <div class="page-container">
    ...
    <div class="header-wave-section">
      <div class="header-nav">
        <a href="{{ route('login') }}" class="back-btn" title="Back to Login">
    ...
    <div class="form-content">
      <p class="email-notice-text">Enter your valid Email</p>

      <form action="{{ route('forgot-code') }}" method="GET">
        <div class="form-group">
          ...
          <div class="input-container">
            ...
            <input type="text" class="input-field" placeholder="Login@rmail.com" value="toluadejimi@gmail.com">
          </div>
        </div>

        <div class="btn-row" style="margin-top: 25px;">
          <a href="{{ route('forgot-code') }}" class="btn-primary">CONTINUE</a>
        </div>
      </form>
