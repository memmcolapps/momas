...
@section('title', 'Reset Password - MomasPay')
@section('body_class', '')
  ...
  <div class="page-container">
    ...
    <div class="header-wave-section">
      <div class="header-nav">
        <a href="{{ route('forgot-code') }}" class="back-btn" title="Back">
    ...
    <!-- Form Section -->
    <div class="form-content" style="justify-content: center; padding-top: 40px;">
      <p class="email-notice-text" style="margin-bottom: 10px;">Enter valid details</p>

      <form action="{{ route('password-success') }}" method="GET">
        <div class="form-group">
          ...
          <div class="input-container">
            ...
            <input type="password" class="input-field" placeholder="*******" value="newpassword123">
        ...
        <div class="btn-row" style="margin-top: 30px;">
          <a href="{{ route('password-success') }}" class="btn-primary">RESET</a>
        </div>
      </form>
    </div>
  </div>
