                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    @if($preview == null)
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-6 my-2 col-sm-12" id="tariff_type_container" style="display: none;">
                                                                <label class="my-2">Tariff Type</label>
                                                                <select class="form-control"
                                                                        name="tariff_type"
                                                                        id="tariff_type">
                                                                    <option value="nepa">NEPA Tariff</option>
                                                                    <option value="gen">Generator Tariff</option>
                                                                </select>
                                                            </div>


                                                            <div class="col-xl-6 my-2 col-sm-12">
                                                                <label class="my-2">Token Fee</label>
                                                            ...
                                                            $(document).ready(function () {
                                                                $('#estate_id, #meterNo').on('change input', function () {
                                                                    ...
                                                                    if (estate_id && (meterNo.length === 11 || meterNo.length === 13)) {
                                                                        $.ajax({
                                                                            url: '/admin/check-meter-dual-tariff',
                                                                            method: 'GET',
                                                                            data: {
                                                                                estate_id: estate_id,
                                                                                meterNo: meterNo
                                                                            ...
                                                                            success: function (response) {
                                                                                if (response.isDualTariff) {
                                                                                    $('#tariff_type_container').show();
                                                                                    $('#tariff_type').prop('required', true);
                                                                                } else {
                                                                                    $('#tariff_type_container').hide();
                                                                                    $('#tariff_type').prop('required', false);
                                                                                }
                                                                            },
                                                                            error: function () {
                                                                                $('#tariff_type_container').hide();
