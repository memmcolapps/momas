...
@section('title', 'Access Token Created - MomasPay Plus')
@section('body_class', '')
...
<!-- Top Navigation Bar -->
  ...
  <main class="page-container success-bg" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 40px 20px;">
    ...
    <!-- Title -->
    <h2 style="color: #00A859; font-weight: 800; font-size: 1.25rem; margin-bottom: 20px; text-align: center;">Access Token Created Successful</h2>

    <!-- Zigzag Serrated Paper Receipt Card -->
    <div class="receipt-wrapper">
      <div class="receipt-title">Access Token Detalis</div>
      ...
      <div class="receipt-row">
        ...
        <span class="receipt-row-val">Access Token</span>
      </div>
      ...
      <!-- Access Token -->
      <div class="receipt-row">
        <span class="receipt-row-label">Access Token:</span>
        <div class="receipt-copy-box">
          <span class="receipt-row-val" style="font-size: 1rem; color: #0F172A;">4415838</span>
          <button type="button" class="copy-badge-icon" aria-label="Copy Access Token">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <rect x="9" y="9" width="13" height="13" rx="2"></rect>
              <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
            </svg>
    ...
    <div class="action-buttons-row" style="margin-top: 15px;">
      ...
      <button type="button" class="square-action-btn" onclick="if(navigator.share){navigator.share({title:'Access Token',text:'Token: 4415838'})}else{alert('Token copied to clipboard!')}" aria-label="Share">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
